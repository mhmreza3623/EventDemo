...
/// <summary>
/// این سرویس صرفا در همان روزی که تراکنش انجام شده است پاشخ معتبری دارد و در روزهای آینده نمی‌تواند پاسخ قابل استنادی در مورد تراکنش مورد استعلام ارائه نماید
/// </summary>
public class ProxyInquiryRequest
{
    /// <summary>
